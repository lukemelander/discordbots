...
Professor: But, like most politicians he promised more than he could deliver.''',
    ...
    ''' Gore: I'm Al Gore. And these are my Vice Presidential Action Rangers! A group of top nerds who's sole duty it is to prevent disruptions in
...
insults = [
    "No thanks. You can keep your STDs. They suit you better.",
    "What? No dinner?!? No drinks?!? I'm not THAT cheap of a date.",
    "Not til I have a ring on my finger.",
    "Didn't I tell you? I'm celebate. Sorry.",
    "Please leave your fantasies out of this!",
    "You're really gonna have to work on your 'pick up lines.'",
    "No, thanks. I'll pass.",
    "Oh, you're SUCH the romantic.",
    "Wait, are we on the set of a Quentin Tarantino film?!? I forgot my l line, but I'm pretty sure it's the same one as yours.",
    "OK, but I'll be on the top.",
    "Daydreaming again, sweetheart?",
    "Get in the queue.",
    "Manners! You gotta ask me out for dinner first.",
    "That'll cost you 1500 dollars for hundreds of hours of my time",
    "Feeling lonely again, ha?",
    "Well, if you insist…",
    "I would, but I have standards.",
    "No thanks.",
    "I don't do charity work.",
    "I am not that bored and you are not that lucky.",
    "Not tonight. I have headache.",
    "Right now? In front of all these people?",
    "Baby, you can't handle me.",
    "You'd like that wouldn't you?",
    "That's what I told your mom last night",
    "Nah, I'm tired from fucking your mother"
]
