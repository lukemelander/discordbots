...
class Screeners(commands.Cog, name= 'Screener'):
    ...
    @commands.command(name="CB PT [TICKER]", brief='Shows price targets for a ticker.', description='')
